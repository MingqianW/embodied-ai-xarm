"""Stable physics-cadence measurement primitive for xArm evaluation.

The formal simulation evaluator may use this module to record diagnostic
evidence. It neither changes control targets nor exposes MuJoCo ground truth
to a learned policy. Experiment orchestration does not belong here.
"""
