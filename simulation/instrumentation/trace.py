"""Stable physics-cadence instrumentation primitives for xArm simulation.

Evaluation and diagnostics may use this module to record evidence. It neither
changes control targets nor exposes MuJoCo ground truth to a learned policy.
Experiment orchestration does not belong here.
"""
