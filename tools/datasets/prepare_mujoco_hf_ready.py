...
DEFAULT_RAW = dataset_root() / "xarm_mujoco_red_block_raw"
DEFAULT_OUTPUT = output_root() / "hf_ready" / "xarm_mujoco_red_block_v1"
...
```bash
python -m tools.datasets.upload_mujoco_dataset_to_hf \
