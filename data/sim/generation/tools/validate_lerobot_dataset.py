...
DEFAULT_DATASET = dataset_root() / "xarm_mujoco_red_block_lerobot"
DEFAULT_RAW_INPUT = dataset_root() / "xarm_mujoco_red_block_raw"
DEFAULT_OUTPUT = output_root() / "dataset_validation"
DEFAULT_OPENPI_ASSETS = output_root() / "openpi_smoke_assets"
DEFAULT_REAL_SCHEMA = output_root() / "sim_data_pipeline_audit" / "current_real_schema.json"
DEFAULT_COMPARISON_CSV = output_root() / "real_sim_comparison" / "distribution_comparison.csv"
EXPECTED_FEATURES = {
    "image": {
        "dtype": "image",
        "shape": [480, 640, 3],
