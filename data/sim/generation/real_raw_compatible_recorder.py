...
class RealCompatibleRawEpisodeRecorder:
    ...
    def __init__(
        ...
        *,
        ...
        self._last_gripper_target_raw: float | None = None
    ...
    def record_observation(
        self,
        *,
        gripper_target_raw: float | None = None,
    ) -> None:
        ...
        if gripper_target_raw is not None and (
            self._last_gripper_target_raw is None
            or abs(float(gripper_target_raw) - self._last_gripper_target_raw) >= 0.5
        ):
            target = float(gripper_target_raw)
            ...
            self._last_gripper_target_raw = target
