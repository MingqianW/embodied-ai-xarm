...
# 每个手指相对中心向外移动的最大距离。
# 两个手指一起移动，所以总开口约为 80 mm。
GRIPPER_OPEN_HALF_WIDTH = 0.040
...
def main() -> None:
    ...
    print("Gripper full opening: approximately 80 mm")
