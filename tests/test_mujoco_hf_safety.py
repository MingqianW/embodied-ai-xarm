...
from sim_mujoco.scripts.prepare_mujoco_hf_ready import prepare
from sim_mujoco.scripts.upload_mujoco_dataset_to_hf import (
    build_upload_plan,
    execute,
)
...
class HuggingFaceSafetyTests(unittest.TestCase):
    ...
    def test_upload_requires_upload_yes_and_no_dry_run(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with mock.patch(
                "sim_mujoco.scripts.upload_mujoco_dataset_to_hf._repo_status",
